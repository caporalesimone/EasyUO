...
var
  RPM  : function(Hnd, Base : Cardinal; Buffer : Pointer; Size : Cardinal; var Code : Cardinal) : Boolean; stdcall;
  WPM  : function(Hnd, Base : Cardinal; Buffer : Pointer; Size : Cardinal; var Code : Cardinal) : Boolean; stdcall;
  HMod : Cardinal;
...
var
  Code : Cardinal;
begin
  Result:=WPM(PHandle,MemPos,Buf,Length,Code);
end;
...
initialization
  ...
  RPM:=GetProcAddress(HMod,'ReadProcessMemory');
  WPM:=GetProcAddress(HMod,'WriteProcessMemory');
finalization
  FreeLibrary(HMod);
end.
